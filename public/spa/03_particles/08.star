...
class2d_em_cmd       "Check command"                          bi-chat-right-text   cli        ?          show       ?
#
loop_
_indata.id
_indata.label
...
do_em_fs             "Expectation-Maximization Parameters"    bi-chat-right-text   fieldset   ?          show       ?
