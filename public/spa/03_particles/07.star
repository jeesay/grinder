...
reextract_ptcls_cmd  "Check command"                          bi-chat-right-text   cli        ?          show       ?
#
loop_
_indata.id
_indata.label
...
_reextract_ptcls_cmd.constraint
...
do_recenter          "Re-center refined coordinates"          bi-chat-right-text   switch     ?          show       ?
...
_general.constraint
_general.help
fndata_reextract     "Refined particles STAR file: "     file       ?               "ParticleGroupMetadata.star.relion" 1               "Input STAR file (*.{star})" ?               
