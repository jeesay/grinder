...
3d_align_cmd         "Check command"                          bi-chat-right-text   cli        ?          ?
#
loop_
_indata.id
_indata.label
...
dont_skip_align_fs   "Perform image alignment"                bi-chat-right-text   fieldset   ?          ?
sampling             "Options"                                bi-chat-right-text   fieldset   ?          ?
do_local_ang_searches "Perform local angular searches?"        bi-chat-right-text   switch     ?          ?
