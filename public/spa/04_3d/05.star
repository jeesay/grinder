...
multibody_flex_cmd   "Check command"                          bi-chat-right-text   cli        ?          ?
#
loop_
_indata.id
_indata.label
...
do_analyse_fs        "Run flexibility analysis"               bi-chat-right-text   fieldset   ?          ?
do_select            "Select particles based on eigenvalues?" bi-chat-right-text   switch     ?          ?
