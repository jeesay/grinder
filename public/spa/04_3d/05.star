...
loop_
_multibody_flex.id
_multibody_flex.label
_multibody_flex.icon
_multibody_flex.widget
_multibody_flex.value
_multibody_flex.help
...
multibody_flex_cmd   "Check command"                          bi-chat-right-text   cli        ?          show       ?
#
loop_
_indata.id
_indata.label
...
_indata.constraint
_indata.help
fn_in                "Consensus refinement optimiser.star: " file       ?           "STAR Files (run_it*_optimiser.star)" "Refine3D/."    "?"             required        
...
;
fn_bodies            "Body STAR file:"                   file       ?               "STAR Files (*.{star})" "."             "?"             required        
...
_system.constraint
_system.help
do_analyse           "Run flexibility analysis?"         bool       true            "?"             "?"             "?"             ?               
...
#
loop_
_multibody_flex_cmd.id
_multibody_flex_cmd.label
_multibody_flex_cmd.widget
_multibody_flex_cmd.default
_multibody_flex_cmd.arg0
_multibody_flex_cmd.arg1
_multibody_flex_cmd.arg2
_multibody_flex_cmd.constraint
_multibody_flex_cmd.help
#
loop_
_settings.id
_settings.label
...
do_analyse_fs        "Run flexibility analysis"               bi-chat-right-text   fieldset   ?          show       ?
do_select            "Select particles based on eigenvalues?" bi-chat-right-text   switch     ?          show       ?
...
loop_
_do_analyse_fs.id
_do_analyse_fs.label
_do_analyse_fs.widget
_do_analyse_fs.default
_do_analyse_fs.arg0
_do_analyse_fs.arg1
_do_analyse_fs.arg2
_do_analyse_fs.constraint
_do_analyse_fs.help
nr_movies            "Number of eigenvector movies:"     range      3               0               16              1               ?               
; Series of ten output maps will be generated along this many eigenvectors.
These maps can be opened as a 'Volume Series' in UCSF Chimera, and then displayed as a movie.
They represent the principal motions in the particles.
;
#
loop_
_do_select.id
...
_do_select.arg1
_do_select.arg2
_do_select.constraint
_do_select.help
select_eigenval      "Select on eigenvalue:"             range      1               1               20              1               ?               
; This is the number of the eigenvalue to be used in the particle subset selection (start counting at 1).
;
eigenval_min         "Minimum eigenvalue:"               range      -999.0          -50             50              1               ?               
; This is the minimum value for the selected eigenvalue; only particles with the selected eigenvalue larger than this value will be included in the output particles.star file
;
eigenval_max         "Maximum eigenvalue:"               range      999.0           -50             50              1               ?               
; This is the maximum value for the selected eigenvalue; only particles with the selected eigenvalue less than this value will be included in the output particles.star file
;
#
loop_
_diskio.id
