...
subselect_mic_cmd    "Check command"                          bi-chat-right-text   cli        ?          ?
#
loop_
_indata.id
_indata.label
...
_indata.arg2
_indata.help
fn_mic               "OR select from micrographs.star:"  file       LABEL_MICS_CPIPE "STAR files (*.star)" 1               ?               "A micrographs.star file to select micrographs from."
#
loop_
_outdata.id
_outdata.label
