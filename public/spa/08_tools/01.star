...
loop_
_subselect_class.id
_subselect_class.label
_subselect_class.icon
_subselect_class.widget
_subselect_class.value
_subselect_class.help
...
subselect_class_cmd  "Check command"                          bi-chat-right-text   cli        ?          ?
#
loop_
_indata.id
_indata.label
...
_indata.arg2
_indata.help
fn_model             "Select classes from job:"          file       OptimiserData.star.relion "STAR files (*_optimiser.star)" 1               ?               
; A _optimiser.star (or for backwards compatibility also a _model.star) file from a previous 2D or 3D classification run to select classes from.
;
#
loop_
_outdata.id
...
#
loop_
_subselect_class_cmd.id
_subselect_class_cmd.label
_subselect_class_cmd.widget
_subselect_class_cmd.default
_subselect_class_cmd.arg0
_subselect_class_cmd.arg1
_subselect_class_cmd.arg2
_subselect_class_cmd.help
#
loop_
_settings.id
_settings.label
...
_settings.value
_settings.help
do_class_ranker      "Automatically select 2D classes?"       bi-chat-right-text   switch     ?          ?
general              "General"                                bi-chat-right-text   fieldset   ?          ?
do_regroup           "Regroup the particles?"                 bi-chat-right-text   switch     ?          ?
do_select_values     "Select based on metadata values?"       bi-chat-right-text   switch     ?          ?
do_discard           "OR: select on image statistics?"        bi-chat-right-text   switch     ?          ?
do_split             "OR: split into subsets?"                bi-chat-right-text   switch     ?          ?
do_remove_duplicates "OR: remove duplicates?"                 bi-chat-right-text   switch     ?          ?
do_filaments         "OR: select filaments by dendrogram?"    bi-chat-right-text   switch     ?          ?
#
loop_
_do_class_ranker.id
