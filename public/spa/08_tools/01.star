...
subselect_class_cmd  "Check command"                          bi-chat-right-text   cli        ?          show       ?
#
loop_
_indata.id
_indata.label
...
_indata.constraint
_indata.help
fn_model             "Select classes from job:"          file       ?               "OptimiserData.star.relion" 1               "STAR files (*_optimiser.star)" required        
...
_subselect_class_cmd.constraint
