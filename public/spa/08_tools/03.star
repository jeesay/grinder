...
subselect_ptcls_cmd  "Check command"                          bi-chat-right-text   cli        ?          show       ?
#
loop_
_indata.id
_indata.label
...
_indata.constraint
_indata.help
fn_data              "OR select from particles.star:"    file       ?               "ParticleGroupMetadata.star.relion" 1               "STAR files (*.star)" required        "A particles.star file to select individual particles from."
#
loop_
_outdata.id
_outdata.label
...
_subselect_ptcls_cmd.constraint
