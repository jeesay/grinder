...
loop_
_subselect_ptcls.id
_subselect_ptcls.label
_subselect_ptcls.icon
_subselect_ptcls.widget
_subselect_ptcls.value
_subselect_ptcls.help
...
subselect_ptcls_cmd  "Check command"                          bi-chat-right-text   cli        ?          ?
#
loop_
_indata.id
_indata.label
...
_indata.arg2
_indata.help
fn_data              "OR select from particles.star:"    file       LABEL_PARTS_CPIPE "STAR files (*.star)" 1               ?               "A particles.star file to select individual particles from."
#
loop_
_outdata.id
_outdata.label
...
#
loop_
_subselect_ptcls_cmd.id
_subselect_ptcls_cmd.label
_subselect_ptcls_cmd.widget
_subselect_ptcls_cmd.default
_subselect_ptcls_cmd.arg0
_subselect_ptcls_cmd.arg1
_subselect_ptcls_cmd.arg2
_subselect_ptcls_cmd.help
#
loop_
_settings.id
_settings.label
