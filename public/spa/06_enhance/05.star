...
rln_locres_cmd       "Check command"                          bi-chat-right-text   cli        ?          show       ?
#
loop_
_indata.id
_indata.label
...
_system.constraint
_system.help
do_resmap_locres     "Use ResMap?"                       bool       false           "?"             "?"             "?"             ?               
; If set to Yes, then ResMap will be used for local resolution estimation.
;
do_relion_locres     "Use Relion?"                       bool       true            "?"             "?"             "?"             ?               
...
loop_
_rln_locres_cmd.id
_rln_locres_cmd.label
_rln_locres_cmd.widget
_rln_locres_cmd.default
_rln_locres_cmd.arg0
_rln_locres_cmd.arg1
_rln_locres_cmd.arg2
_rln_locres_cmd.constraint
_rln_locres_cmd.help
#
loop_
_settings.id
_settings.label
...
do_relion_locres_fs  "Relion Parameters"                      bi-chat-right-text   fieldset   ?          show       ?
...
#
loop_
_do_relion_locres_fs.id
_do_relion_locres_fs.label
_do_relion_locres_fs.widget
_do_relion_locres_fs.default
_do_relion_locres_fs.arg0
_do_relion_locres_fs.arg1
_do_relion_locres_fs.arg2
_do_relion_locres_fs.constraint
_do_relion_locres_fs.help
adhoc_bfac           "User-provided B-factor:"           range      -100            -500            0               -25             ?               
; Probably, the overall B-factor as was estimated in the postprocess is a useful value for here.
...
; The MTF of the detector is used to complement the user-provided B-factor in the sharpening.
If you don't have this curve, you can leave this field empty.
;
#
loop_
