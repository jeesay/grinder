...
sub_mask_cmd         "Check command"                          bi-chat-right-text   cli        ?          show       ?
#
loop_
_indata.id
_indata.label
...
_system.constraint
_system.help
do_center_mask       "Do center subtracted images on mask?" bool       true            "?"             "?"             "?"             ?               
; If set to Yes, the subtracted particles will be centered on projections of the center-of-mass of the input mask.
;
do_center_xyz        "Do center on my coordinates?"      bool       false           "?"             "?"             "?"             ?               
...
_sub_mask_cmd.id
_sub_mask_cmd.label
_sub_mask_cmd.widget
_sub_mask_cmd.default
_sub_mask_cmd.arg0
_sub_mask_cmd.arg1
_sub_mask_cmd.arg2
_sub_mask_cmd.constraint
_sub_mask_cmd.help
#
loop_
_settings.id
