...
ucsf_mc_cmd          "Check command"                          bi-chat-right-text   cli        ?          ?
#
loop_
_indata.id
_indata.label
...
_indata.arg2
_indata.help
input_star_mics      "Input movies STAR file:"           file       LABEL_MOVIES_CPIPE "STAR files (*.star)" 1               ?               "A STAR file with all micrographs to run MOTIONCORR on"
#
loop_
_outdata.id
_outdata.label
