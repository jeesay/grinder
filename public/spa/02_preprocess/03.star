...
ctf_cmd              "Check command"                          bi-chat-right-text   cli        ?          ?
#
loop_
_indata.id
_indata.label
...
_indata.arg2
_indata.help
input_star_mics      "Input micrographs STAR file:"      file       LABEL_MICS_CPIPE "STAR files (*.star)" 1               ?               "A STAR file with all micrographs to run CTFFIND or Gctf on"
#
loop_
_outdata.id
_outdata.label
...
_settings.value
_settings.help
do_phaseshift        "Estimate phase shifts"                  bi-chat-right-text   switch     ?          ?
