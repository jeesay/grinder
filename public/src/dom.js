...
const parseArg2 = (arg0,arg1) => {
  let _id = (typeof arg0 === 'string') ? arg0 : '';
  let _options = (typeof arg1 === 'object') ? arg1 : {};
...
const parseArg4 = (arg0,arg1,arg2,arg3) => {
  let _id = (typeof arg0 === 'string') ? arg0 : '';
  let _options = (typeof arg1 === 'object') ? arg1 : {};
  let _content = (typeof arg2 === 'string') ? arg2 : '';
  let _children = (Array.isArray(arg3)) ? arg3 : [];
  return [_id,_options,_content,_children];
}

const _parseArgs = [parseArg1,parseArg2,parseArg3,parseArg4];

const error = () => {
  throw 'ERR: Too much arguments';
}

const parseArgs = (args) => (args.length <= 4) ? _parseArgs[args.length - 1](...args) : error();
 ...
 * 
 */ 
const h = (...args) => nodeHTML(...parseArgs(args));
...
export {h,a,button,div,input,p,span};
